    ...
    <>
      <div className="flex flex-wrap  h-[50vh]">
        <div className="w-[60%] p-10 ">
          ...
          <p className='text-0xl text-justify mt-6'>Through our dedicated   services, we bridge the gap between food donors and those in need. From   ensuring food quality to seamless delivery tracking, we make every  effort to create a reliable, efficient, and compassionate system that  transforms surplus food into hope for communities in need.
          </p>
